...
Jako první bylo nutné určit, do jakého žánru bude Astra spadat. Od tud poté bylo možné zvolit další postup. Z důvodu osobní preference tohoto žánru jsem nakonec zvolil tzv. \textit{\enquote{top-down shoot-em-up}}, konkrétně jeho podžánr \textit{\enquote{bullet hell}}.
...
\section{Chyby a neimplemetovaný obsah}
...
\end{itemize}
\section{Instalace}
Pokud používáte operační systém Windows, spusťte soubor Astra_x.x.x_ installer.exe následujte pokyny na obrazovce. Po dokončení instalece můžete hru spustit pomocí souboru Astra.exe ve vámi zvolené instalační složce.
Pokud používate Linux, TBD
