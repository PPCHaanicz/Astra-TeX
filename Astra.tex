...
Za prvé jsem jej rozdělil do dvou, na sobě minimálně závislých systémů. Jeden, který se stará o nepřátele jako celek (hlídá, aby ve hře nebylo příliš mnoho protivníků na jednou apod.) a druhý, který řídí každý jednoho nepřítele. Nejdříve se budu zabývat prvním zmíněným.\\
...
\begin{figure}[h!]
	...
	\caption{BP{\_}MasterSpawner, kód pro kontrolu spawnování nepřátel}
	\label{masterspawner}
\end{figure}
\clearpage
